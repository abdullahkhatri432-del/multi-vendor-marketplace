...
import { Store, Mail, Lock, Eye, EyeOff, User, AlertCircle, CheckCircle } from 'lucide-react';
    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12 animate-fade-in">
      <div className="w-full max-w-md">
          ...
          {step === 'verify-email' && (
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="font-medium text-surface-900">{form.email}</p>
              </div>
        ...
        <p className="mt-6 text-center text-sm text-surface-500">
          {step === 'form' && 'Already have an account? '}
          {step === 'form' && (
