    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12 animate-fade-in">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-surface-500">Join Speedersmania with your phone number</p>
        </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    else if (digits.length <= 6) setPhoneNumber(`${digits.slice(0, 3)} ${digits.slice(3)}`);
                    else if (digits.length <= 10) setPhoneNumber(`${digits.slice(0, 3)} ${digits.slice(3, 6)} ${digits.slice(6)}`);
                    else setPhoneNumber(`${digits.slice(0, 3)} ${digits.slice(3, 6)} ${digits.slice(6, 10)}`);
                  }}
